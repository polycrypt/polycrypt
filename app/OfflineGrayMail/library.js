...
window.onload = function() {
    ...
    var encryptNonce = function() {
        ...
        var importOp = window.polycrypt.importKey("jwk", JSON.parse(otherPublicKeyJWK), "RSAES-PKCS1-v1_5");
     ...
     *	The derived key K will have the form: K = PBKDF2(H(N_user) XOR H(N_other) || password, null, 2048)
     */
    var go = function() {
        ...
        decryptNonceOp.oncomplete = function(e) {
            ...
            /* Hash your nonce using the other user's public key */
            ...
            /* Generate the salt which is: salt = H_us XOR H_other */
    ...
    var encrypt = function() {
        ...
        var data = util.str2abv(document.getElementById("plaintext").value);
        ...
        encryptOp.oncomplete = function(e) {
            ...
            document.getElementById("ciphertext").value = all;
    ...
    var decrypt = function() {
        var all = document.getElementById("ciphertext").value;
        ...
        decryptOp.oncomplete = function(e) {
            ...
            document.getElementById("plaintext").value = util.abv2str(e.target.result);
        }
    }
